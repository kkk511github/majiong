...
export function ruleSections(
  ...
  if (isNanjingV2(rules)) {
    ...
    sections.push([
      "风牌奖励与罚分",
      b
        ? `${rules.fourWinds ? "自己开局前四次出牌须连续打出东南西北各一张，顺序不限，其他每家付5分；夹入其他牌即失效，后面补齐不算。" : "本桌关闭四连风奖励。"}${rules.discardPenalties ? `首轮庄家出风牌，其他三家按座序各自第一张跟同一种风牌，庄家向其他每家付5分；碰杠会打断跟牌。单人累计打齐同种四张，向其他每家付5分，再应用本把倍率。` : "本桌关闭弃牌罚分。"}前述两项风牌收付固定每家5分，不乘花砸2或本把倍率。`
