...
// Original: shared/scoring-nanjing.ts
// Commit: 8b1c03f8258de9085325cd5845b94a28dd91a2b7 (parent of the 5d34034 fix)
// Original SHA-256: ff5d2cdc503cd48340440dc25041e19141a74a59c73491f686c6d38e4adc0c30
// Only import paths changed; all original scoring semantics are preserved.
import { counts, kind } from "../../shared/tiles";
import { shapes, type Shape } from "../../shared/hand-shapes";
import { flowerFactor, isNanjingB, nanjingValues } from "../../shared/nanjing-rules";
import type { WinContext } from "./listening-164068-scoring-before";
import type { Player, Rules, WinScore, Seat } from "../../shared/types";
