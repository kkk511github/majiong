...
export function ruleSections(
  ...
  if (isNanjingV2(rules)) {
    ...
    sections[5] = [
      "结算与过水",
      `普通点炮付一份，自摸其他三家各付一份。多人同时胡牌统一结算；${rules.twoBankrupt ? "桌内余额归零的玩家不能被点胡或抢杠胡；付款不足按各家应得比例分配，两家归零结束本桌。" : "敞开头允许记负分，按约定局数结算。"}${rules.protectWinner ? "胡牌结算导致两家归零时，胡牌者不足 100 分的，优先从其他余额最多玩家的可用分补足；多人胡牌不相互扣回保米。" : ""}放弃胡或碰后，须自己下一次出牌才解除对应过水限制。`,
    ];
    sections.push([
      "天胡、地胡与比下胡",
